...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="{{url('admin')}}">Employee MS</a>
    <!-- Sidebar Toggle-->
...
{{--                    Department--}}
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{url('department')}}">View</a>
                            <a class="nav-link" href="{{url('department/create')}}">Add</a>
                        </nav>
                    </div>
{{--                    Department last --}}
                    {{--                    Employee--}}
                    ...
                    <div class="collapse" id="empMenu" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            ...
                            <a class="nav-link" href="{{url('employee/create')}}">Add</a>
                        </nav>
                    </div>
                    {{--                    Employee last --}}
